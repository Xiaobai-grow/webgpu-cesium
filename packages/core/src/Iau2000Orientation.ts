...
import { IauOrientationParameters } from "./IauOrientationParameters"
...
const Iau2000Orientation: {
  ComputeMoon: (date?: JulianDate, result?: IauOrientationParameters) => IauOrientationParameters
} = {} as {
  ComputeMoon: (date?: JulianDate, result?: IauOrientationParameters) => IauOrientationParameters
}
 ...
 * @private
 */
Iau2000Orientation.ComputeMoon = function (
  date?: JulianDate,
  result?: IauOrientationParameters,
  ...
  if (!defined(result)) {
    result = new IauOrientationParameters(rightAscension, declination, rotation, rotationRate)
  }
